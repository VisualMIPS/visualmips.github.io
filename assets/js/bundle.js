...
var director = createCommonjsModule(function (module) {
//
...
var Util = function (__exports) {
    var load = __exports.load = function (key) {
        return defaultArg(localStorage.getItem(key), null, function ($var7) {
...
setType("Main.program", program);
var registers = function () {
    function registers(numberOfRegisters) {
...
setType("Main.registers", registers);
...
setType("Main.register", register);
function getById(id) {
